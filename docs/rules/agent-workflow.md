...
### 사람이 읽는 설명과 접힌 실행 정보 — 제안

이 절은 [Issue #194](https://github.com/blahaj94/ldb/issues/194)의 변경안입니다. Draft PR의 명시적인 사용자 승인 전에는 템플릿 교체와 기존 Issue 일괄 적용의 근거로 사용하지 않습니다.

```yaml
status: proposed
enforcement: warning
rationale: 사람이 첫 설명만 읽어도 작업의 이유와 변경 방향을 이해하고 필요한 판단에 참여할 수 있도록 합니다.
evidence: "https://github.com/blahaj94/ldb/issues/194"
...
승인 후 템플릿의 본문 구조는 다음과 같습니다. 아래 꺾쇠 안의 안내 대신 실제 작업 설명과 정보를 작성합니다.

```markdown
## 작업 설명

문제와 필요한 이유, 주요 변경, 기대 결과를 연결한 설명입니다.
사람의 판단이 필요한 사항과 중요한 제약은 이 영역에 명시합니다.

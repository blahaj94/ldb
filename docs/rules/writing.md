...
이슈, PR, 댓글을 작성하거나 다듬기 전에 [텍스트 작성과 판단 책임](agent-text-writing.md)의 사용자 선택 및 사실 검토 기준도 함께 확인합니다.
...
- 사람이 읽는 답변과 문서, GitHub의 Issue, Discussion, Project 설명, PR 본문, 리뷰와 답글, 댓글, commit 본문에 적용합니다. 텍스트 작성의 판단 책임과 기존 필수 항목, 승인 절차는 변경하지 않습니다.

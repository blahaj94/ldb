...
export const UserSchema = new EntitySchema<User>({
  ...
  uniques: [{ name: 'uq_users_provider_subject', columns: ['provider', 'providerSubject'] }],
  checks: [
    {
    ...
    {
      name: 'ck_users_provider_subject_nonempty',
      expression: `char_length("provider_subject") > 0`
    },

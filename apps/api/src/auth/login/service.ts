...
export function createLoginService(dependencies: LoginDependencies): LoginHttpService {
  if (!dependencies.dataSource?.isInitialized || dependencies.dataSource.options.logging !== false ||
    !dependencies.registry || !dependencies.pkceKeys || typeof dependencies.verifyProvider !== 'function' ||
    typeof dependencies.issueAccessJwt !== 'function') throw new LoginFailure(LOGIN_ERRORS.INTERNAL)
